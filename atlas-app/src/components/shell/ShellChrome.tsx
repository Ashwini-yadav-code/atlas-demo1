  ...
  return (
    <>
      <nav className="sidebar" id="sidebarRail" aria-label="Tools">
        <div className="side-btn" title="Search" role="button" tabIndex={0} onClick={() => setSearchOpen(true)}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="7" /><path d="M21 21l-4.3-4.3" /></svg>
        </div>
        <Link href="/messages" className="side-btn" title="Messages">
        ...
        <Link href="/checklist" className="side-btn" title="Document vault">
        ...
        <div className="side-btn" title="Help & support" role="button" tabIndex={0} onClick={() => setHelpOpen(true)}>
        ...
        <Link href="/profile" className="side-btn" title="Settings">
      ...
      <div className="main">
        <div className="topbar">
          ...
          <div className="top-right">
            <button type="button" className="icon-btn" title="Notifications" onClick={() => setNotifOpen(true)}>
            ...
            <button type="button" className="profile-btn" title="Account menu" onClick={onAvatarClick} style={{ appearance: "none", border: "none", background: "none" }}>
